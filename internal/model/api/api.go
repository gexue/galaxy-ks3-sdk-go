...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/gexue/galaxy-ks3-sdk-go/aws": true,
	}
}
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["github.com/gexue/galaxy-ks3-sdk-go/internal/signer/v4"] = true
	a.imports["github.com/gexue/galaxy-ks3-sdk-go/internal/protocol/"+a.ProtocolPackage()] = true
...
func (a *API) ExampleGoCode() string {
	...
	code := fmt.Sprintf("import (\n%q\n%q\n%q\n\n%q\n%q\n%q\n%q\n)\n\n"+
		...
		"github.com/gexue/galaxy-ks3-sdk-go/service/"+a.PackageName(),
		strings.Join(exs, "\n\n"),
	)
	return util.GoFmt(code)
}
...
func (a *API) InterfaceGoCode() string {
	a.resetImports()
	a.imports = map[string]bool{
		"github.com/gexue/galaxy-ks3-sdk-go/service/" + a.PackageName(): true,
	}
...
func (a *API) InterfaceTestGoCode() string {
	...
	a.imports = map[string]bool{
		"testing": true,
		"github.com/gexue/galaxy-ks3-sdk-go/service/" + a.PackageName():                                  true,
		"github.com/gexue/galaxy-ks3-sdk-go/service/" + a.PackageName() + "/" + a.InterfacePackageName(): true,
